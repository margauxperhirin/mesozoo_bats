...
images$taw_name <- substr(images$object_id, start = 1, stop = 12) # Correcting wrong data (checked with Amy)
images$acq_sub_part[images$taw_name %in% c('b334_t3_d3_a','b334_t3_d3_b')] <- 64 # 64 instead of 128
